...
**web binding** of the token graph, and they bind the web surfaces in full.
Other tiers inherit as [Binding Tiers](#binding-tiers) describes; every TV
surface, native ones within their platform conventions, treats the web TV
list-first look as the shared family look.
