...
- [Platform Strategy](https://github.com/putdotio/workspace-frontend/blob/main/docs/platform-strategy.md) — native vs hybrid, architecture, agent workflow
...
- One frontend engineer (the frontend lead) + AI coding agents — see [Platform Strategy](https://github.com/putdotio/workspace-frontend/blob/main/docs/platform-strategy.md)
...
Scope has evolved into a full platform strategy. See [Platform Strategy](https://github.com/putdotio/workspace-frontend/blob/main/docs/platform-strategy.md) for the architecture and implementation plan.
