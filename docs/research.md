...
### User 09
Data engineer at Expedia. Found through a friend. Loved the $1 EFF donation. Uses browser + Chromecast. Shared login with friends. 5-year user who didn't know about ShowRSS, ecosystem apps, or YouTube downloads. "This is a huge lesson — we need to teach people these features exist."

### User 10
Growth strategist. Found through friend. NAS → Apple TV → Plex. Recently started using Watchio + 1TB and downloading less. Most knowledgeable user interviewed — knows ecosystem apps, ShowRSS, everything. Offered to help with growth for free.

### User 11
MBA student. Sister's account originally. Watches on laptop, Chromecast when TV available. Didn't know about ecosystem apps or ShowRSS. Also offered to help with strategy (politely declined).
...
### User 13
Event promoter (spiritual/ayahuasca events). 1TB account, archivist mindset. Pays to curate a collection. Frustrated that next tier up is too expensive — wants incremental storage addon. Ecosystem-apps-only user. "Torrent is impossible to explain to someone who doesn't know." Wants posters for discovery.
...
### User 37
Maker/designer. Most eclectic user. Unemployed, living on benefits, makes games (FixPix, Abductor Pro). **Has designed fonts.** Watches RuPaul's Drag Race with friends — that's how he found put.io. 100GB monthly. MacBook, iPhone, iPad, AirPlay to 3rd gen Apple TV. Has 4K Sony Android TV but refuses to use it because "Android is disgusting." Apple Music subscriber. **Loves the rainbow iOS icon.** ecosystem apps user, has specific feedback: ⬇️ icon confused him (thought = local download), repetitive strings in search results should be cleaned up to focus on season/episode. Suggested sponsoring drag screening events for marketing. Real story: a screening's streaming source crashed mid-event — put.io would have saved it.
...
| Legal anxiety | Even technical users feel uneasy. Ecosystem apps looking sketchy compounds this. | Premium design = implicit trust. Craft communicates legitimacy. |
...
| The torrent wall | "I tried to explain but they don't know what a torrent is." Growth dies here. | ecosystem apps (or equivalent) must abstract torrents completely for newcomers. |
...
| Quote | Who | Context |
|---|---|---|
| "It just works!" | User 04 | Systems architect, lives on a river boat |
| "Instant Torrents" | User 04 | Suggested brand positioning |
| "I thought you were a British company with 100 people" | User 35 | iOS engineer at Zalando, Berlin |
| "ecosystem apps looked like a ready-made template, didn't feel secure" | User 33 | Technical lead, Berlin |
| "The ⬇️ icon made me think it'd download to my computer" | User 37 | Maker/designer, Berlin |
| "Just one button: Download to put.io" | User 38 | UI Designer at EyeEm, Berlin |
| "Safe, because Turks thought of the legal details" | User 33 | Implicit trust in the team |
| "I cancelled Netflix and Amazon Prime" | User 32 | Web designer, Berlin |
| "Word of mouth from a friend at lunch was more impactful than any online ad" | User 35 | Berlin |
| "We changed 3 buttons' colors in 4 weeks" | User 35 | What he imagined put.io's pace was |
| "Google cache'inden TPB kullanmak bıktırıyor" | User 35 | On discovering ecosystem apps |
| "I pay because I enjoy curating my collection" | User 13 | Archivist persona, London |
| "Android is disgusting" | User 37 | Refuses to use his Sony Android TV |
| "3 ayı bedavaya getirdik!" | User 33 | On receiving voucher cards |
