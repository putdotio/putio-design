...
2. [`putio-frontend-handbook/docs/platform-strategy.md`](https://github.com/putdotio/putio-frontend-handbook/blob/main/docs/platform-strategy.md) — how we build (native, agents, VLC-kit)
