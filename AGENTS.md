...
2. [`putio-workspace-frontend/docs/platform-strategy.md`](https://github.com/putdotio/putio-workspace-frontend/blob/main/docs/platform-strategy.md) — how we build (native, agents, VLC-kit)
