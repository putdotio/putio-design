...
This policy covers the public design-system site, token package, and brand
assets owned by this repository.

## Guidelines

- Include the affected URL, package version, token artifact, or asset path when
  it is relevant.
...
The current `main` branch, the live design guide, and the latest published npm
